    ...
    <div className="analyticsPage">
      ...
      <div className="analyticsHeader">
        ...
        <div className="analyticsSubtitle">
          This page summarizes outcomes and simple strategy performance for the selected date range.
          ROI assumes a <b>$1 stake</b> per game.
        </div>
      </div>
      ...
      <div className="section">
        ...
        <div className="toolbarRow">
          <div className="pill">Strategy view: <b>{stratLabel(strategy)}</b></div>
          ...
          <div className="toolbarRowRight">
            <span className="pill">Equity points: <b>{equity.length}</b> · Bets in buckets: <b>{nBetsInBuckets}</b></span>
          </div>
        </div>

        {/* Charts layout: scroll vs 2-up */}
